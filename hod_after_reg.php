...
<?php } ?>
<?php if (!empty($_SESSION['email31'])) {
  $email = $_SESSION['email31'];
  ...
  $_SESSION['dept31'] = $fetch[0]['Department'];
  $_SESSION['name31'] = $fetch[0]['Name'];
  if (isset($_SESSION['thres112'])) {
    unset($_SESSION['thres112']);
  }
  ...
  if(isset($_SESSION['date112'])) {
    unset($_SESSION['date112']);
  }
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 2.5%;">
  ...
  <div class="card-body">
    <h5 class="card-title"><a href="hdisplayAll.php">Check Attendance</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="hdanger_zone.php">Danger Zone</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="hdate_wise.php">Advanced Search</a></h5>
  ...
  <button name='logout' type="submit" style="color: white; margin-top: 15px; padding-top: 5px; padding-bottom: 5px; background-color: #343a40; text-decoration: none;" ><a style="color: white; text-decoration: none;" href="hod_det_atndn.php">&#8678 Check attendance of another class</a></button>
  <br><br><br>
</center>
<!-- Optional JavaScript -->
