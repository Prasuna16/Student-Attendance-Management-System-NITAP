...
<?php if (!empty($_SESSION['email1'])) {
  ...
  $_SESSION['dept3'] = $fetch[0]['Department'];
  $_SESSION['name3'] = $fetch[0]['Name'];
  $name = $_SESSION['name3'];
  $dept = $_SESSION['dept3'];
	...
	if (isset($_POST['check'])) {
		if (isValid() == 'Yes') {
			...
			global $table;
			global $dept, $yr, $sm;
			$_SESSION['table21'] = $table;
			$_SESSION['sub21'] = $_POST['sub_code'];
			$_SESSION['dept21'] = $dept;
			$_SESSION['yr21'] = $yr;
			$_SESSION['sm21'] = $sm;
			$_SESSION['email21'] = $email;
			header('Location: fac_after_reg.php');
		}
	}
