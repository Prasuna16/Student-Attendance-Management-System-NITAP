<?php  
  session_start();
	...
	function isValid() {
		...
		$query = "SELECT Password, Name from faculty where email='$email'";
		...
		if (empty($pass)) {
			$errors['email'] = "Account doesn't exist with this email!";
			return 'No';
	...
	if (isset($_POST['submit'])) {
      ...
      $_SESSION['email1'] = $_POST['email'];
			header('Location: chk_atndnce.php');
		}
	}
...
<html>
<head>
<title>Faculty Register Portal</title>
<meta charset="utf-8">
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <img src="arrowleft.png" style="float: left; margin-left: 20px; " width="40" height="30" alt="Back">
      ...
      <div class="welcome">Faculty Login Portal</div>
    </div>
    <!-- <?php //if (!empty($n)) { ?>
