...
<form method="post">
  ...
  <center>
<button name="submit" type="submit" style="color: white; background-color: #343a40" >Register</button>
</center>

</form>
<p style="font-family: Comic Sans MS; color: black; padding-top: 20px; font-size: 21px;">Already have an account?<a href="stu_login.php"> Login</a></p>
</center>
<!-- Optional JavaScript -->
