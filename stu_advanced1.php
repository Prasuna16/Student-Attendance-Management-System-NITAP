  ...
  font-size: 25px;
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    ...
    <img src="arrowleft.png" style="float: left; margin-left: 20px; " width="40" height="20" alt="Back">
				...
				<center><h6><?php echo $reg.'-'.$_SESSION['name']; ?></h6></center>
			<center>
			<table class="table table-bordered" style="width: 60%; margin-top: 3%;">
			  ...
			  <tbody>
							<?php for ($i = 0; $i<count($subjects); $i++) {
						    		$pre = $subjects[$i].'_P';
									$tot = $subjects[$i].'_T';
									$q1 = "SELECT date1 from $table join student on $table.RegNo=student.RegNo where $table.RegNo = '$reg' and date1 is not null and $pre=0 and $tot=1";
		...
		</tr></tr></tbody></table></center></center></body></html>