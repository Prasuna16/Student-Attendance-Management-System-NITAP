...
<?php } ?>
<?php if (!empty($_SESSION['email21'])) {
	$email = $_SESSION['email21'];
  ...
  $_SESSION['dept21'] = $fetch[0]['Department'];
  $_SESSION['name21'] = $fetch[0]['Name'];
  if (isset($_SESSION['thres'])) {
    unset($_SESSION['thres']);
  }
  ...
  if(isset($_SESSION['date123'])) {
    unset($_SESSION['date123']);
  }
...
<body>
<div class="p-3 mb-2 bg-secondary text-white" style="text-align: center; font-size: 25px;">Hello <?php echo $fetch[0]['Name'] ?>, Welcome!</div>
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 2.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="displayAll.php">Check Attendance</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="add_attendance.php">Edit Attendance</a></h5>
    <p class="card-text">Click the above link to modify (add/delete) attendance of a class.</p>
    <p class="card-text"><small class="text-muted">Last updated on <?php echo $fet[0]['dtm'];?></small></p>
  </div>
</div>
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="danger_zone.php">Danger Zone</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="date_wise.php">Advanced Search</a></h5>
  ...
  <button name='logout' type="submit" style="color: white; margin-top: 15px; padding-top: 5px; padding-bottom: 5px; background-color: #343a40; text-decoration: none;" ><a style="color: white; text-decoration: none;" href="chk_atndnce.php">&#8678 Check attendance of another class</a></button>
  <br><br><br>
</center>
<!-- Optional JavaScript -->
