<?php  
  ...
  function isValid() {
    ...
    $query = "SELECT cmail, cpass FROM login WHERE cmail = '$user' AND cpass = '$password'";
  ...
  if (isset($_POST['submit'])) {
    if (isValid() == 'Yes') {
      $_SESSION['email51'] = $_POST['user'];
      header('Location: cor_after_reg.php');
    }
  }
...
<html>
<head>
<title>Coordinator Login Portal</title>
<meta charset="utf-8">
...
<body>
    ...
    <img src="arrowleft.png" style="float: left; margin-left: 20px; " width="40" height="30" alt="Back">
      ...
      <div class="welcome">Coordinator Login Portal</div>
    </div>
    <!-- <?php //if (!empty($name)) {  -->?>
