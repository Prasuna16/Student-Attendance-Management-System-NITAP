...
//     if (isset($_SESSION['LAST_ACTIVIT4']) && (time() - $_SESSION['LAST_ACTIVI4'])>40) {
//       session_unset();
//       session_destroy();
//     }
//     $_SESSION['LAST_ACTIVIT4'] = time();
  ...
  <?php //} ?>
	...
	if (isset($_POST['check'])) {
		if (isValid() == 'Yes') {
			global $table;
			global $dept, $yr, $sm;
			$_SESSION['table5'] = $table;
			$_SESSION['sub5'] = $_POST['sub_code'];
			$_SESSION['dept5'] = $dept;
			$_SESSION['yr5'] = $yr;
			$_SESSION['sm5'] = $sm;
...
<form method="post">
  ...
  <center>
<button name="check" type="submit" style="color: white; margin-top: 25px; padding-top: 5px; padding-bottom: 5px; background-color: #559955" >Go!</button>
</center>
