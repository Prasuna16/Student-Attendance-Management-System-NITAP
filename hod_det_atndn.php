  ...
  $dept = $_SESSION['dept31'];
	...
	if (isset($_POST['check'])) {
		if (isValid() == 'Yes') {
			global $table;
			global $dept, $yr, $sm;
			$_SESSION['table31'] = $table;
			$_SESSION['sub31'] = $_POST['sub_code'];
			$_SESSION['dept31'] = $dept;
			$_SESSION['yr31'] = $yr;
			$_SESSION['sm31'] = $sm;
			$_SESSION['email31'] = $email;
			header('Location: hod_after_reg.php');
		}
	}
