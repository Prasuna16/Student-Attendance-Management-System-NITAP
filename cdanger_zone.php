...
<?php if (!empty($_SESSION['table51'])) {
  ...
  if ($table == 'physics' || $table == 'chemistry') {
    ...
    $query = "SELECT Name, $table.RegNo,$tot, $pre from student s join $table on s.RegNo = $table.RegNo where $tot != 0 and $pre < $pre_needed and date1 is null and s.Section='$sec' order by $table.RegNo";
  ...
  if(isset($_POST['apply'])) {
      $_SESSION['thres142'] = $_POST['thre'];
      header('Location: cdanger_zone.php');
  }
...
.welcome {
  ...
  <body>
    ...
    <center><h5 style="margin-top: 1%;"><?php echo $d?></h5></center>
	<center><h6><?php echo $yr . " -" . "  ($sub)"; ?></h6></center><br>
