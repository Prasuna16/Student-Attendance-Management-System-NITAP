...
<?php if (!empty($_SESSION['email51'])) {
  if (isset($_SESSION['thres142'])) {
    unset($_SESSION['thres142']);
  }
  ...
  if(isset($_SESSION['date142'])) {
    unset($_SESSION['date142']);
  }
...
<body>
<div class="p-3 mb-2 bg-secondary text-white" style="text-align: center; font-size: 25px;">Hello Coordinator, Welcome!</div>
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 2.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="cdisplayAll.php">Check Attendance</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="cdanger_zone.php">Danger Zone</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="cdate_wise.php">Advanced Search</a></h5>
  ...
  <button name='logout' type="submit" style="color: white; margin-top: 15px; padding-top: 5px; padding-bottom: 5px; background-color: #343a40; text-decoration: none;" ><a style="color: white; text-decoration: none;" href="cor_after_reg.php">&#8678 Check attendance of another class</a></button>
  <br><br><br>
</center>
<!-- Optional JavaScript -->
